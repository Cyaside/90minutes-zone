...
// Listen to custom event pattern: document.dispatchEvent(new CustomEvent('toast',{detail:{title,message,type,duration}}))
document.addEventListener('toast', (e)=>{
  if (!e.detail) return;
  const { title = 'Notification', message = '', type = 'normal', duration = 3000 } = e.detail;
